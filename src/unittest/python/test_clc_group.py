...
class TestClcServerFunctions(unittest.TestCase):
    ...
    def test_ensure_group_is_absent_group_exists(self):
        ...
        # Test
        result_changed, result_group = under_test._ensure_group_is_absent(
    ...
    def test_get_group(self):
        ...
        # Assert Result
        mock_clc_sdk.v2.Datacenter().Groups().Get.assert_called_once_with(
            "MyCoolGroup")
    ...
    def test_get_group_not_found(self):
        ...
        # Setup
        with patch.object(clc_group, 'clc_sdk') as mock_clc_sdk:
            mock_clc_sdk.v2.Datacenter().Groups().Get.side_effect = clc_sdk.CLCException(
                "Group not found")
            under_test = ClcGroup(self.module)
