...
def initialize( project ):
	...
	project.set_property("run_unit_tests_command", "nosetests -w %s --exe -v --with-xunit --xunit-file=target/reports/nosetests_results.xml" % project.expand_path("$dir_source_unittest_python"))
